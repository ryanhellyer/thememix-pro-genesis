...
Right now the only thing this plugin does is add a login page template to your list of available page templates. Humble beginnings, but we have a lot in store for this plugin.
...
= 0.2 =
* Addition of Featured Content widget.
